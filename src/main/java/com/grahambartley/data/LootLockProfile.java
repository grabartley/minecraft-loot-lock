...
public final class LootLockProfile {
	...
	public LootLockProfile(UUID id, String name, FilterMode mode, RejectedItemAction rejectedItemAction, boolean enabled, List<RuleEntry> rules) {
		this.id = id == null ? UUID.randomUUID() : id;
		this.name = (name == null || name.isBlank()) ? "Default" : name;
		this.mode = mode == null ? FilterMode.DENYLIST : mode;
		this.rejectedItemAction = rejectedItemAction == null ? RejectedItemAction.LEAVE_ON_GROUND : rejectedItemAction;
